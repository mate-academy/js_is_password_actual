...
describe(`Function 'isPasswordActual'`, () => {
  ...
  it('should match the example: password from 2021-06-01 is still actual', () => {
    expect(isPasswordActual(2021, 6, 1)).toBe('Password is actual.');
  });

  it('should match the example: password from 2021-05-01 should be changed', () => {
  ...
  it(`should return 'You should change your password.' when password is 31 days old`, () => {
  ...
  it(`should return 'Immediately change the password!' when password is 61 days old`, () => {
    const d = new Date(2021, 5, 10);
